...
(function dartProgram() {
  ...
  A.main_closure.prototype = {
    call$0() {
      ...
      _isAwesomeMapping.get = t4._as(A.allowInterop(new A.main__closure(_dartInstance), t3));
      t5 = t1._as(t2.Object);
      t5.defineProperty.apply(t5, [_jsExporter, "isAwesome", _isAwesomeMapping]);
      t5 = t1._as(t2.Object);
      _nameMapping = t1._as(t5.create.apply(t5, [null]));
      _nameMapping.get = t4._as(A.allowInterop(new A.main__closure0(_dartInstance), t3));
      t5 = t1._as(t2.Object);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.FixedLengthListMixin, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.Closure, A._Required, A.MapBase, A.LinkedHashMapCell, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A._UnmodifiableMapMixin, A.Null, A.StringBuffer, A.DartApp]);
